const events = [
    ...
    },
    {
        ...
        startDate: "2024-12-23", // Updated to match debrief text (Dec 23)
        endDate: "2025-01-04",   // Updated to match debrief text (Jan 4)
        startTime: "03:00 PM",    // Normalized to uppercase
        endTime: "12:00 AM",      // Normalized to uppercase
        location: "boCHE 1000 Acres",
        isTicketed: true,
        bookingLink: "",
        description: "",
