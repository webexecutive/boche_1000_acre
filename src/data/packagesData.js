...
const packages = [
 
  {
    ...
    activities: [
      { id: 1, name: "Visit 900 Kandi",                                image: "900-kandi.jpg" },
      { id: 2, name: "Visit Soochipara Waterfall",                     image: "soochipara-waterfall.jpg" },
      { id: 3, name: "Visit Chooral Mala",                             image: "chooral-mala.jpg" },
      { id: 4, name: "Boche Adventure Park (Sky Cycling or Zip Line)", image: "boche-adventure-park.jpg" },
      { id: 5, name: "Jungle Safari",                                  image: "jungle-safari.jpg" },
    ],
