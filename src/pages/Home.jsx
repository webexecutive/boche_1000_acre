...
function Home() {
    ...
    if (videoRef.current) {
      ...
      if (playPromise !== undefined) {
        playPromise.catch((error) => {
          // Ignore the play() interrupted strictly harmless dev error
        });
      }
    }
  }, [videoSrc]);
      ...
      <section className="bg-[#F7FDE9] py-20">
        ...
        <div className="max-w-7xl mx-auto px-4  ">
          ...
          <EmblaCarousel
            ...
            sectionSubtitle="Comfort Meets Nature">
            {rooms.map((room) => (
              <div className="embla__slide" key={room.id}>
                <RoomCard
                  image={room.images?.[0]?.small || "/images/image-not-found-small.webp"}
  ...
  "
      >
        ...
        <div className="max-w-7xl relative mx-auto px-4 ">
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center w-full">
            ...
            {/* LEFT GRID */}
            <div
              className="order-2 md:order-1 grid grid-cols-2 gap-2"
              style={{ gridTemplateRows: "repeat(3, 160px)" }}
            >
              <div className="row-span-2 rounded-xl overflow-hidden bg-[#c8b89a]">
                <img src={toddy2} className="w-full h-full object-cover" />
              </div>
              <div className="rounded-xl overflow-hidden bg-[#c8b89a]">
                <img src={toddy1} className="w-full h-full object-cover" />
              </div>
              <div className="rounded-xl overflow-hidden bg-[#c8b89a]">
                <img src={toddy3} className="w-full h-full object-cover" />
              </div>
              <div className="rounded-xl overflow-hidden bg-[#c8b89a]">
                <img src={toddy4} className="w-full h-full object-cover" />
              </div>
              <div className="rounded-xl overflow-hidden bg-[#c8b89a]">
                <img src={toddy5} className="w-full h-full object-cover" />
              </div>
            </div>
            ...
            <div className="order-1 md:order-2 flex flex-col items-center text-center gap-6">
              <div>
                ...
                <p className="text-gray-500 max-w-lg">
                  Experience authentic toddy shop flavors and the finest toddy, served in the refreshing climate of Wayanad with an exceptional ambiancel.
                </p>
              </div>
          ...
          <img
            src={bocheWithFood}
            className="hidden xl:block absolute -bottom-20 -right-16 h-96"
          />

          <p className="absolute -bottom-20 left-2.5 bg-white text-sm text-gray-500">
      ...
      <section className="bg-[#F7FDE9] py-20 ">
        <div className="max-w-7xl relative mx-auto px-4 ">
          <EmblaCarousel sectionTitle="Adventure Experiences"
            sectionSubtitle="More ways to feel alive">
      ...
      {/*bhoomiputhara section*/}
      <section
        className="
 
    bg-[linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url('/images/bhoomiputhrabg-sm.webp')]
    md:bg-[linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url('/images/bhoomiputhrabg-md.webp')]
    lg:bg-[linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url('/images/bhoomiputhrabg-lg.webp')]
  ...
  "
      >
        <div className="max-w-7xl mx-auto px-6 md:px-8 py-20 text-white flex flex-col items-center space-y-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div >
              <img
                src="/images/teaFactory.webp"
                className="w-full max-w- rounded-xl object-cover"
                alt="Tea Factory"
              />
            </div>
      ...
      <section className="
    py-20  
    bg-[linear-gradient(rgba(254,255,251,0.9),rgba(254,255,251,0.9)),url('/images/gallerybg-sm.svg')]
    md:bg-[linear-gradient(rgba(254,255,251,0.9),rgba(254,255,251,0.9)),url('/images/gallerybg-md.svg')]
    lg:bg-[linear-gradient(rgba(254,255,251,0.9),rgba(254,255,251,0.9)),url('/images/gallerybg-lg.svg')]
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 shrink-0">
              ...
              <button
                onClick={() => { setShowMenu(false); setPageNumber(1); }}
                className="bg-gray-100 text-black w-9 h-9 rounded-full flex items-center 
        justify-center text-lg leading-none hover:bg-gray-200 transition"
              >
                ✕
              </button>
            </div>
            ...
            <div className="flex items-center justify-center gap-3 py-3 px-4 border-t border-gray-200 bg-white shrink-0">
              <button
                ...
                className="px-4 py-2 text-sm bg-gray-200 rounded-lg disabled:opacity-40 hover:bg-gray-300 transition active:scale-95"
              >
                ← Prev
              </button>
              ...
              <button
                onClick={() => goToPage((prev) => Math.min(prev + 1, numPages))}
                disabled={pageLoading || !numPages || pageNumber === numPages}
                className="px-4 py-2 text-sm bg-gray-200 rounded-lg disabled:opacity-40 hover:bg-gray-300 transition active:scale-95"
              >
                Next →
              </button>
